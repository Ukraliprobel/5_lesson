...
def letter_stat(our_str):
    ...
    """
    функция на вход принимает строку и возращает словарь letters_dict, где в качестве ключей буквы строки,
    а значениями являются числа, соответствующие количеству вхождений данной буквы в строку.
    :param our_str: Строка
    :return: Словарь. В качестве ключей буквы строки, а значения - это числа.
    """
    letters_dict = {}
    for i in our_str:
