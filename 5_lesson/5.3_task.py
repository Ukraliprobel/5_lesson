...
def everything_for_your_cat(cats_data):
    ...
    """
    функция принимает данные о котиках и оптимизирует их хранение таким образом,
    чтобы для каждого владельца при выводе (одна строка)
    данные о всех его животных отображались в одной строке,
    на новой строке следующий покупатель и все его питомцы и т.д.
    :param cats_data: Кортеж: Кличка котика, Возраст котика, Имя покупателя, Фамилия покупателя
